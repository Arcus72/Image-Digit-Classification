...
# TODO: Add demo and files info to README
# TODO: Make it live.
...
with gr.Blocks() as demo:
    ...
    gr.Markdown("""
    ## GitHub Repository
    If you want to see the training process, data augmentation, and how the model was built,  
        check out the **[main_analysis.ipynb](https://github.com/Arcus72/Image-Digit-Classification)** file in my GitHub repository.""")
